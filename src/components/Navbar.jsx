    ...
    <div>
      <div className="h-16 top-0 bottom-0 flex fixed justify-between items-center w-full bg-white z-10  ">
        <div className="flex items-center gap-5  ">
          <GiHamburgerMenu
            className="text-xl lg:text-2xl  font-semibold ml-3 lg:ml-6 cursor-pointer"
        ...
        <div className="flex">
          ...
          <input
            ...
            placeholder="Search.."
          />
          <CiSearch className="text-xl hidden lg:block  bg-gray-300/30 w-16 p-1 rounded-e-2xl text-black h-10 " />
        </div>
        <div className="flex gap-4 m-3 items-center">
          <CiBellOn className="text-3xl text-black" />
          <RiVideoDownloadFill className="hidden lg:block text-3xl text-black" />
          <Avatar
            alt="Remy Sharp"
            ...
            className=""
          />
          <CiSearch className="text-xl   lg:hidden w-16 p-1 rounded-e-2xl text-black h-10 " />
        </div>
      </div>
    </div>
  );
